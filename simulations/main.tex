...
\item Find the optimal decision boundary using MAP criterion.
...
\begin{align}
	...
	pf_N\brak{\vec{y} - A\vec{s}_0} \gtrless& (1 - p)f_N\brak{\vec{y} - A\vec{s}_1} \\
...
\end{align}
or $y - x \gtrless \frac{1}{2}\ln{\brak{\frac{1 - p}{p}}}$.

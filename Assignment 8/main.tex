...
\begin{abstract}
This document contains the solution to Question 16 of Exercise 13.2 in Chapter 13 (Probability) of the NCERT Class 12 Mathematics Textbook.
\end{abstract}
...
\item Using De-Morgan's Laws, we need to get $\pr{E' + F'}$. Thus,
...
\item We need to find $\pr{F|E}$. Therefore,
\begin{align}

...
\begin{lstlisting}
$ wget https://raw.githubusercontent.com/goats-9/ai1110-probability/master/manual/codes/2_2.py
\end{lstlisting}
and execute it with
\begin{lstlisting}
$ python3 2_2.py
...
\solution
This has been done in the plots \eqref{fig:tri-pdf} and \eqref{fig:tri-cdf}.
\end{enumerate}
...
\end{lstlisting}
and run by typing the commands
\begin{lstlisting}
$ python3 6_1_cdf.py
$ python3 6_1_pdf.py
\end{lstlisting}

...
\end{lstlisting}
		...
		\end{enumerate}
The CDF is expressed in terms of the Q-function as $F_X(x) = 1 - Q(x)$.
\item
...
\begin{lstlisting}
$ wget https://github.com/goats-9/ai1110-assignments/manual/codes/tri_cdf.py
\end{lstlisting}
...
\begin{lstlisting}
$ wget https://github.com/goats-9/ai1110-assignments/manual/codes/tri_pdf.py
\end{lstlisting}
and run using
\begin{lstlisting}
$ python3 tri_pdf.py
...
\solution
This has been done in the plots shown in 4.2 and 4.3.
\end{enumerate}
...
\solution
The file exrand.c in 1.1 generates the numbers in the file gau\_ber.dat
\item Plot Y.
	\begin{figure}
		\includegraphics[width=\columnwidth]{figs/wave.png}
		\caption{Plot of $Y$}
		\label{fig:wave}
	\end{figure}
...
\begin{lstlisting}
$ wget https://github.com/goats-9/ai1110-probability/manual/codes/ber_gau.py
\end{lstlisting}
and run using
\begin{lstlisting}
$ python3 ber_gau.py
...
\begin{lstlisting}
$ wget https://github.com/goats-9/ai1110-assignments/manual/codes/max_like.py
\end{lstlisting}
...
\item Verify by plotting the theoretical $P_e$.
	\begin{figure}
		\includegraphics[width=\columnwidth]{figs/error.png}
...
\begin{lstlisting}
$ wget https://goats-9/ai1110-assignments/manual/codes/err_a.py
\end{lstlisting}
